    ...
    public void MoveGunPointToLeft()
    {
        ...
        if (player.currentWeaponIndex == 0)
        {
            ...
            transform.localScale =
                initialScale
                    .WithAxis(Axis.X, value: 0.5f)
                    .WithAxis(Axis.Y, value: 0.5f);
        }
        ...
        if (player.currentWeaponIndex == 1)
        {
            newPosition =
                initialPosition
                    .WithAxis(Axis.X, value: -0.21f)
                    .WithAxis(Axis.Y, value: 3.1f)
                    .WithAxis(Axis.Z, value: 1.0f);

            transform.localScale =
                initialScale
                    .WithAxis(Axis.X, value: 1.0f)
                    .WithAxis(Axis.Y, value: 1.0f);
        }
        ...
        if (player.currentWeaponIndex == 2)
        {
            newPosition =
                initialPosition
                    .WithAxis(Axis.X, value: -0.3f)
                    .WithAxis(Axis.Y, value: 2.8f);
        ...
        if (player.currentWeaponIndex == 4)
        {
            newPosition =
                initialPosition
                    .WithAxis(Axis.X, value: -0.1f)
                    .WithAxis(Axis.Y, value: 3f);
